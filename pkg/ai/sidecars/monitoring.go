...
func (s *Builder) reconcilePodMonitor(ctx context.Context, p *aiApi.AIPlatform) error {
...
func (s *Builder) reconcilePrometheusRule(ctx context.Context, p *aiApi.AIPlatform) error {
