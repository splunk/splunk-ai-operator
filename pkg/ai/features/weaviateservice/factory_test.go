...
func TestWeaviateServiceFactory_New(t *testing.T) {
	s := runtime.NewScheme()
	_ = scheme.AddToScheme(s)
	_ = aiv1.AddToScheme(s)

	factory := &WeaviateServiceFactory{}
	...
	reconciler, ok := handler.(*WeaviateServiceReconciler)
	assert.True(t, ok, "Expected handler to be *WeaviateServiceReconciler")
