...
# Pinned to the version validated in DEPLOYMENT_GUIDE.md's Hardware Requirements
# and used throughout K0S_README.md/TEST_PLAN.md. Override with --k0s-version
# for a different release; "latest" resolves the newest k0s release at run time.
...
OPTIONS
  ...
  --k0s-version VER     Specific k0s release to download.
