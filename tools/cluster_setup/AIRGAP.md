...
Model weights (>120 GB total) are not included in the binary bundle. They must
...
|---|---|---|
| Disk (free) | 250 GB | >120 GB for 10 model weight files + buffer for download staging |
