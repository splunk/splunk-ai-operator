...
func (in *AIPlatformSpec) DeepCopyInto(out *AIPlatformSpec) {
	*out = *in
	...
	if in.GPUWorkerConfig != nil {
		in, out := &in.GPUWorkerConfig, &out.GPUWorkerConfig
		*out = new(GPUWorkerConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerTierSpec) DeepCopyInto(out *WorkerTierSpec) {
	*out = *in
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerTierSpec.
func (in *WorkerTierSpec) DeepCopy() *WorkerTierSpec {
	if in == nil {
		return nil
	}
	out := new(WorkerTierSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUWorkerConfig) DeepCopyInto(out *GPUWorkerConfig) {
	*out = *in
	if in.InstanceTypes != nil {
		in, out := &in.InstanceTypes, &out.InstanceTypes
		*out = make(map[string][]WorkerTierSpec, len(*in))
		for key, val := range *in {
			var outVal []WorkerTierSpec
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make([]WorkerTierSpec, len(*in))
				for i := range *in {
					(*in)[i].DeepCopyInto(&(*out)[i])
				}
			}
	...
	if in.InstanceScale != nil {
		in, out := &in.InstanceScale, &out.InstanceScale
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUWorkerConfig.
func (in *GPUWorkerConfig) DeepCopy() *GPUWorkerConfig {
	if in == nil {
		return nil
	}
	out := new(GPUWorkerConfig)
