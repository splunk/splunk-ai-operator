...
ZARF_DIR := tools/ai-tier-cluster-setup/zarf
...
zarf-build-complete: zarf-check helm-package ## Build complete Zarf package (k0s + operator + platform)
	...
	@echo "See tools/ai-tier-cluster-setup/zarf/docs/COMPLETE_DEPLOYMENT.md"
...
zarf-all: helm-all zarf-build zarf-inspect ## Build Helm charts and Zarf package
	...
	@echo ""
	@echo "See tools/ai-tier-cluster-setup/zarf/docs/zarf-deployment.md for complete guide"
