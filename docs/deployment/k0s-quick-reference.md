...
The SAIA images currently use the `preview` tag.
...
After mirroring, replace the corresponding fully qualified image values in the
cluster config with the mirrored paths. Mirror the Slim and operator images
